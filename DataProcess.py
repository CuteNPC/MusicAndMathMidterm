...
def trans_1_order(file_list):  # 输入待统计的文件路径列表
    ...
    pitch_trans_matrix_freq = normalize_2dim(pitch_trans_matrix_num, pitch_trans_matrix_freq)
    rhythm_trans_matrix_freq = normalize_2dim(rhythm_trans_matrix_num, rhythm_trans_matrix_freq)
...
def trans_2_order(file_list):
    pitch_trans_matrix_num = [[[0 for i in range(16)] for i in range(16)] for i in range(16)]
    pitch_trans_matrix_freq = [[[0 for i in range(16)] for i in range(16)] for i in range(16)]
    rhythm_trans_matrix_num = [[[0 for i in range(11)] for i in range(11)] for i in range(11)]
    rhythm_trans_matrix_freq = [[[0 for i in range(11)] for i in range(11)] for i in range(11)]
    ...
    pitch_trans_matrix_freq = normalize_3dim(pitch_trans_matrix_num, pitch_trans_matrix_freq)
    rhythm_trans_matrix_freq = normalize_3dim(rhythm_trans_matrix_num, rhythm_trans_matrix_freq)
    ret = Info(pitch_trans_matrix_freq, rhythm_trans_matrix_freq)
    # print(pitch_trans_matrix_freq)
    # print(rhythm_trans_matrix_freq)
    return ret
